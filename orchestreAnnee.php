...
<div class="container">
    <div id="margin_bottom">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Recherche des chef d'orchestre
        ...
        <form class="form-signin" method="post" action="orchestreAnnee.php" >
        ...
        if (isset($_POST['anneeNaissance']) && isset($_POST['anneeMort']))
        {
            ...
            $con->musicienAnnee($anneeNaissance, $anneeMort,3);
        }
        ?>
